...
document.writeln("					<label onclick=\"window.location.href=\'main.html\'\" style=\'color: #30333F;\'><span  id=\'redline1\' style=\'border-bottom:2px solid white;padding-bottom:6px;\'>推荐</span></label>");
document.writeln("				</td>");
document.writeln("				<td align=\'center\'>");
document.writeln("					<label onclick=\"window.location.href=\'game.html\';\" style=\'color: #30333F;\'><span  id=\'redline2\' style=\'border-bottom:2px solid white;padding-bottom:6px;\'>赛历</span></label>");
document.writeln("				</td>");
document.writeln("				<td align=\'center\'> ");
document.writeln("					<label onclick=\"window.location.href=\'video.html\';\" style=\'color: #30333F;\'><span  id=\'redline3\' style=\'border-bottom:2px solid white;padding-bottom:6px;\'>视频</span></label>");
document.writeln("				</td>");
document.writeln("				<td align=\'center\'>	");
document.writeln("					<label onclick=\"window.location.href=\'luntan.html\';\" style=\'color: #30333F;\'><span  id=\'redline4\' style=\'border-bottom:2px solid white;padding-bottom:6px;\'>论坛</span></label>");
document.writeln("				</td>");
document.writeln("			</tr>");
